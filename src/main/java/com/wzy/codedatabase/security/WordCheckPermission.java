...
public class WordCheckPermission extends Permission
{
   ...
   public boolean implies(Permission other)
   {
      ...
      {
         System.out.println(Arrays.toString(getName().toCharArray()));
         System.out.println(Arrays.toString(b.getName().toCharArray()));
         System.out.println(getName().contains(b.getName()));
